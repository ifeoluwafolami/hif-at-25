...
export const ModalFrame: React.FC<FrameProps> = ({
  ...
  return ReactDOM.createPortal(
    ...
    >
      <div
        ref={container}
        className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-xl bg-[#f8f8f8] p-6 shadow-xl sm:p-8"
      ...
      >
        ...
        <button
          ...
          className="absolute top-4 right-4 text-2xl font-bold text-[#e45781] hover:text-[#e45781]/80 focus:outline-none"
        >
          ×
        </button>
...
export const ModalHead: React.FC<SectionProps> = ({ children }) => (
  <div className="mb-4 text-xl font-bold text-[#e45781]">{children}</div>
);

export const ModalBody: React.FC<SectionProps> = ({ children }) => (
  <div className="text-[#e45781] space-y-4">{children}</div>
);
